<template>
    <div class="login">
      ...
      <div class="loginBox">
        <h3 class="helloh3">欢迎登录</h3>
        <el-form class="login_form"
        :model="loginForm" :rules="rules">
        <el-form-item prop="user"  style="margin-top:15px;">
            <el-input prefix-icon="user" placeholder="请输入用户名" v-model="loginForm.username"></el-input>
          </el-form-item>
          <el-form-item prop="password">
              <el-input prefix-icon="lock" type="password" placeholder="请输入密码" v-model="loginForm.password"></el-input>
          </el-form-item>
        </el-form>
